...
const canonical = canonicalPath("/transfers/levels", siteUrl);
        ...
        <section className="rounded-lg border border-surface-variant bg-surface-container-low p-5">
          {entries.length === 0 ? (
            <p className="text-sm text-on-surface-variant">
              {dataUnavailable
                ? "Transfer academic levels are temporarily unavailable. Please try again shortly."
                : "No academic levels are available yet."}
            </p>
          ) : (
